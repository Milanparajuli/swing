...
public class SignUp extends JFrame{
	public SignUp(){
		...
		dayOption.setBounds(150,230,90,30);
		dayOption.addItem("1");
		dayOption.addItem("2");
		dayOption.addItem("3");
		dayOption.addItem("4");
		...
		buttonLabel.setBounds(180,345,90,30);
		add(buttonLabel);
		JButton buttonField=new JButton();
		buttonField.setBounds(180,345,50,30);
		add(buttonField);
		add(b);
